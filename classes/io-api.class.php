...
class InvoicesOnlineAPI {
    ...
    private function _callCurl($type, $request, $ClientID, $OrderID = false, $docType = false) {
        switch ($type) {
            ...
            case 'balance';
                ...
                $this->cache_file = dirname(__FILE__) . $this->cache_dir . $ClientID . '.cBalance.json';
            ...
            case 'remove_code';
                ...
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . $ClientID . '.RemoveItemByCode.json';
                $this->cache_file = false;
                break;
            case 'add_item';
                $file = 'AddItemTo.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . $ClientID . '.AddItemTo.json';
                $this->cache_file = false;
                break;
            case 'convert';
                $file = 'ConvertProFormaInvoiceToInvoice.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . '.ConvertProFormaInvoiceToInvoice.json';
                $this->cache_file = false;
                break;
            case 'new_client';
                $file = 'NewClient.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . '.NewClient.json';
                $this->cache_file = false;
                break;
            case 'update_client.php':
                $file = 'updateClient.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . '.UpdateClient.json';
                $this->cache_file = false;
                break;
            case 'generate_invoice_batch':
                $file = 'GenerateInvoiceBatch.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . '.GenerateInvoiceBatch.json';
                $this->cache_file = false;
                break;
            case 'generate_new_invoice':
                $file = 'GenerateNewInvoice.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . '.GenerateNewInvoice.json';
                $this->cache_file = false;
                break;
            case 'generate_new_deliverynote':
                $file = 'GenerateNewDeliveryNote.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . '.GenerateNewDeliveryNote.json';
                $this->cache_file = false;
                break;
            case 'generate_new_proforma':
                $file = 'GenerateNewProFormaInvoice.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . '.GenerateNewProFormaInvoice.json';
                $this->cache_file = false;
                break;
            case 'record_payment':
                $file = 'RecordPayment.php';
                // $this->cache_file = dirname(__FILE__) . $this->cache_dir . '.RecordPayment.json';
                $this->cache_file = false;
                break;
            default:
                $file = false;
    ...
    public function GetClientBalance($ClientID) {
        if (!is_numeric($ClientID) || $ClientID < 1) {
            $this->_SetError('method GetClientBalance :: Invalid ClientID');
            return false;
        }
        unset($param, $request);
        $param['username'] = $this->username;
