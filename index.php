...
/**
 * Plugin Name:  Invoices Online Integration
 * Plugin URI: https://www.invoicesonline.co.za
 ...
 * Version: 4.9.1
 * Author URI: https://www.invoicesonline.co.za/
 */
...
function jconline_create_menu()
{
    ...
    add_menu_page('Invoices Online Plugin Settings', 'Invoices Online', 'administrator', __FILE__, 'jconline_settings_page', plugins_url('/assets/images/favicon-16x16.png', __FILE__));
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <div class="io-tab-menu subsubsub">
                ...
                <div class="io_link"><a href="https://www.invoicesonline.co.za/" target="_blank">Invoices Online Website</a></div>
            </div>
            <div class="io-tab-holder active" id="io-settings-tab">
                <table class="wp-list-table widefat plugins">
                    <tr>
                        <td colspan="3">
                            API Information is available on <a href="https://www.invoicesonline.co.za" target="_blank">www.invoicesonline.co.za</a> -> Settings -> API Access
                        </td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                        <th scope="row">Allow Clients to buy on Credit if they have credit in Invoices Online</th>
                        <td>
            ...
            <div class="io-tab-holder" id="io-faq-tab">
                <table class="wp-list-table widefat plugins">
                    <tr valign="top">
                        ...
                        <td><a href="mailto:info@invoicesonline.co.za">info@invoicesonline.co.za</a></td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">Website:</th>
                        <td><a href="https://www.invoicesonline.co.za">www.invoicesonline.co.za</a></td>
                    </tr>
                </table>
            </div>
            <?php submit_button(); ?>
...
{
    error_log('Enqueuing admin scripts'); // Debug statement
...
add_action('admin_enqueue_scripts', 'admin_enqueue_scripts_callback_jconline');
            ...
            function jconline_admin_notice()
            {
                ...
                if (!get_user_meta($user_id, 'io_ignore_notice')) {
                    ...
                    $message .= 'Please set your tax settings in the Invoices Online Settings page | <a href="?io_nag_ignore=0">Hide Notice</a>';
